...
| **LGPL/GPL** | Lisensi FFmpeg: kami redistribute build **GPL** (butuh `libx264`) + atribusi + teks lisensi + link source. Kode kami tetap MIT (binary terpisah). Lihat `docs/THIRD-PARTY-NOTICES.md`. |
